...
const LoginModal = ({ isOpen, onClose, onLoginSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log('🔍 Email has spaces:', email !== email.trim());

    try {
      console.log('🌐 Making API call to: https://api1.shopilam.com/api/v1/auth/signin');
      ...
      const response = await fetch('https://api1.shopilam.com/api/v1/auth/signin', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        window.dispatchEvent(new StorageEvent('storage', { key: 'whatsopify_token', newValue: token }));
